...
public class CommentController {
    ...
    public String commentPage(@PathVariable("commentId") long commentId,
                              Model model) {
    ...
    public String createPage(@PathVariable("bookId") long bookId, Model model) {
    ...
    public String editPage(@PathVariable("commentId") long commentId, Model model) {
