...
class CommentProcessorTest {
    ...
    void process() throws Exception {
        ...
        CommentMigrationDto migrationCommentDto = commentProcessor.process(mongoComment);
        assertThat(migrationCommentDto).isNotNull();
        assertThat(migrationCommentDto.getId()).isEqualTo(COMMENT_MONGO_ID);
        assertThat(migrationCommentDto.getText()).isEqualTo(mongoComment.getText());
        assertThat(migrationCommentDto.getBookId()).isEqualTo(BOOK_MONGO_ID);
    }
}